# exec-plans/completed/index

Статус: `Draft`.

## Назначение

Список завершённых execution plans. Эти документы — “история выполнения” и контекст решений; источник истины по текущему поведению системы — код + SoR-доки.
...
- `2026-03-02-performance-profiling-and-optimization.md`
...
- `2026-02-23-latex-full-log-error-modal.md`
- `2026-02-23-docs-realignment.md`
- `2026-02-25-auth-refresh-stability.md`
- `2026-02-25-radix-primitives-adoption.md`
