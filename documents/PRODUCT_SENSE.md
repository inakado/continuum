...
- Видеть прогресс учеников, блокировки, required skips и очередь ручной проверки развернутых ответов.

### Student value

- Проходить юниты по понятным правилам unlock.
- Получать чёткий feedback по задачам: решено, не решено, заблокировано, нужна ручная проверка.
