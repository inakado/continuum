...
| `GET` | `/teacher/library` | `getLibrary` | `apps/api/src/library/teacher-library.controller.ts:29` |
| `PUT` | `/teacher/library/access-grants` | `setAccessGrant` | `apps/api/src/library/teacher-library.controller.ts:66` |
| `POST` | `/teacher/library/lessons` | `createLesson` | `apps/api/src/library/teacher-library.controller.ts:50` |
| `PATCH` | `/teacher/library/lessons/:id/publish` | `publishLesson` | `apps/api/src/library/teacher-library.controller.ts:58` |
| `POST` | `/teacher/library/sections` | `createSection` | `apps/api/src/library/teacher-library.controller.ts:34` |
| `PATCH` | `/teacher/library/sections/:id/publish` | `publishSection` | `apps/api/src/library/teacher-library.controller.ts:42` |
